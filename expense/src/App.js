...
function App() {
  const expenses = [
    ...
    { id: 'e2', title: 'New TV', amount: 799.49, date: new Date(2021, 2, 12),LocationOfExpenditure:"Dadri", },
  ...
  return (
    <div className="App">
     ...
     LocationOfExpenditure={expenses[0].LocationOfExpenditure}></ExpenseItem>
